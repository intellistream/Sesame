...
export sensor="join.new input_file /home/shaun/Sesame/build/benchmark/datasets/sensor.txt : join.new num_points 100000 : join.new dim 4 : join.new num_clusters 54"
