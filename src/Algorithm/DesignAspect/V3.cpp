...
bool SESAME::V3::checkoutOutlier(SESAME::PointPtr &point)
{
    ...
    if (minDIstance > this->V3Param.outlier_distance_threshold)
        return false;
    else
        return true;
}
...
void SESAME::V3::pointToClusterDist(SESAME::PointPtr &insertPoint, SESAME::NodePtr &node,
                                    double &dist)
{
    dist                      = 0;
...
void SESAME::V3::selectChild(vector<SESAME::NodePtr> &children, SESAME::PointPtr &insertPoint,
                             SESAME::NodePtr &node)
{
    double dist = 0;
    double temp = 0;
...
void SESAME::V3::calculateCorDistance(vector<vector<double>> &distance,
