...
bool SESAME::V7::checkoutOutlier(SESAME::PointPtr &point) {
  ...
  if(neighborNeighborDensity == 0) return true;
    ...
    return (double) neighborDensity / neighborNeighborDensity > this->V7Param.outlier_density_threshold;
  }
}
...
void SESAME::V7::pointToClusterDist(SESAME::PointPtr &insertPoint, SESAME::NodePtr &node, double & dist) {
  dist = 0;
...
void SESAME::V7::selectChild(vector<SESAME::NodePtr> &children, SESAME::PointPtr &insertPoint, SESAME::NodePtr &node) {
  double dist = 0;
  double temp = 0;
...
void SESAME::V7::calculateCorDistance(vector<vector<double>> &distance, vector<SESAME::NodePtr> &nodes) {
...
// concept drift adaption
void SESAME::V7::backwardEvolution(SESAME::NodePtr &curNode, SESAME::PointPtr &point, SESAME::NodePtr &cluster) {
