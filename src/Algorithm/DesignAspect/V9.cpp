 ...
 * */
void SESAME::V9::GridListUpdate(std::vector<int> coordinate)
{
 ...
 */
SESAME::HashMap SESAME::V9::adjustForDenseGrid(DensityGrid grid,
                                                    CharacteristicVector characteristicVec,
                                                    int gridClass)
{
 ...
 * this iteration
 */
SESAME::HashMap SESAME::V9::adjustForTransitionalGrid(DensityGrid grid,
                                                           CharacteristicVector characteristicVec,
                                                           int gridClass)
{
  // Among all neighbours of dg, find the grid h whose cluster ch has the largest size
