...
{
    this->cache =
        SESAME::DataStructureFactory::creatCache(this->V10Param.num_cache, this->V10Param.alpha,
    ...
    this->dpTree =
        SESAME::DataStructureFactory::createDPTree(this->actCluMaxNum, this->V10Param.radius);
...
double SESAME::V10::computeAlpha() { return dpTree->computeAlpha(this->V10Param.minDelta); }
double SESAME::V10::adjustMinDelta() { return dpTree->adjustMinDelta(this->alpha); }
