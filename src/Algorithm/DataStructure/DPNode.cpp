...
void SESAME::DPNode::SetCenter(SESAME::PointPtr &center) { DPNode::center = center; }
...
std::unordered_set<SESAME::DPNodePtr> &SESAME::DPNode::GetSucs() { return sucs; }
void SESAME::DPNode::SetSucs(std::unordered_set<SESAME::DPNodePtr> &sucs) { DPNode::sucs = sucs; }
SESAME::ClusterPtr &SESAME::DPNode::GetCluster() { return cluster; }
void SESAME::DPNode::SetCluster(SESAME::ClusterPtr &cluster) { DPNode::cluster = cluster; }
double SESAME::DPNode::GetInactiveTime() { return inactiveTime; }
void SESAME::DPNode::SetInactiveTime(double inactive_time) { inactiveTime = inactive_time; }
...
std::unordered_set<SESAME::DPNodePtr> &SESAME::Cluster::GetCells() { return cells; }
void SESAME::Cluster::SetCells(std::unordered_set<DPNodePtr> &cells) { Cluster::cells = cells; }
...
void SESAME::DPNode::addSuccessor(SESAME::DPNodePtr &node) { this->sucs.insert(node); }
void SESAME::DPNode::removeSuccessor(SESAME::DPNodePtr &node) { this->sucs.erase(node); }
...
double SESAME::DPNode::getDisTo(SESAME::DPNodePtr &node)
{
    ...
    {
        distance =
            distance + pow(node->center->getFeatureItem(i) - this->center->getFeatureItem(i), 2);
    }
    return sqrt(distance);
}
SESAME::DPNodePtr SESAME::DPNode::copy() { return std::make_shared<DPNode>(*this); }
