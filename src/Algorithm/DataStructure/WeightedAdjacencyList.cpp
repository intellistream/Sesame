...
SESAME::AdjustedWeight::AdjustedWeight(double weight, int pointTime, timespec pointTime0)
{
    this->weight      = weight;
...
{
    long elapsedTime = ((updateTime0).tv_sec * 1000000L + (updateTime0).tv_nsec / 1000L) -
...
double SESAME::AdjustedWeight::getCurrentWeight(double decayFactor) { return weight * decayFactor; }
