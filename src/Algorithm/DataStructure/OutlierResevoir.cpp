...
void SESAME::OutlierReservoir::SetTimeGap(double time_gap) { timeGap = time_gap; }
long SESAME::OutlierReservoir::GetLastDelTime() { return lastDelTime; }
void SESAME::OutlierReservoir::SetLastDelTime(long last_del_time) { lastDelTime = last_del_time; }
...
void SESAME::OutlierReservoir::SetLamd(double lamd) { OutlierReservoir::lamd = lamd; }
std::unordered_set<SESAME::DPNodePtr> &SESAME::OutlierReservoir::getOutliers() { return outliers; }
...
void SESAME::OutlierReservoir::setTimeGap(double timeGap) { this->timeGap = timeGap; }
...
void SESAME::OutlierReservoir::remove(SESAME::DPNodePtr &nn) { this->outliers.erase(nn); }
