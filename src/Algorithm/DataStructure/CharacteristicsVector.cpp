...
// Landmark window
double SESAME::CharacteristicVector::getCurrGridDensity() { return this->gridDensity; }

void SESAME::CharacteristicVector::densityWithNew(int NowTime, double decayFactor)
{
...
void SESAME::CharacteristicVector::UpdateAllDensity(int NowTime, double decayFactor, double dl,
                                                    double dm)
{
...
// Landmark
void SESAME::CharacteristicVector::UpdateAllDensity(int NowTime, double dl, double dm)
{
    // record the last attribute
    int lastAtt = this->attribute;
    // Update the density grid's density
