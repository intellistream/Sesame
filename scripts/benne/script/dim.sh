...
export dim20="join.new input_file $HOME/Sesame/build/benchmark/datasets/Dim-20.txt : join.new num_points 500000 : join.new dim 20 : join.new num_clusters 50 : join.new run_cmm false : join.new arr_rate 0"
export dim40="join.new input_file $HOME/Sesame/build/benchmark/datasets/Dim-40.txt : join.new num_points 500000 : join.new dim 40 : join.new num_clusters 50 : join.new run_cmm false : join.new arr_rate 0"
export dim60="join.new input_file $HOME/Sesame/build/benchmark/datasets/Dim-60.txt : join.new num_points 500000 : join.new dim 60 : join.new num_clusters 50 : join.new run_cmm false : join.new arr_rate 0"
export dim80="join.new input_file $HOME/Sesame/build/benchmark/datasets/Dim-80.txt : join.new num_points 500000 : join.new dim 80 : join.new num_clusters 50 : join.new run_cmm false : join.new arr_rate 0"
