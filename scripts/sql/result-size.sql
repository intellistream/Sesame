...
LEFT JOIN (SELECT algo, num_res FROM main WHERE workload="KDD99") as kdd ON t.algo=kdd.algo
...
LEFT JOIN (SELECT algo, num_res FROM main WHERE workload="EDS_O" AND num_points=100000 AND arr_rate=0) as ods ON t.algo=ods.algo
;
