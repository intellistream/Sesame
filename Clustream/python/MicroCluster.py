...
class MicroCluster:
    ...
    :parameter linear_sum is the linear sum of the points in the cluster. (LS)
    :parameter squared_sum is  the squared sum of all the points added to the cluster.(SS)
    :parameter linear_time_sum is  the linear sum of all the timestamps of points added to the cluster.(LST)
    :parameter squared_time_sum is  the squared sum of all the timestamps of points added to the cluster. (SST)
