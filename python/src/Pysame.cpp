...
PYBIND11_MODULE(pysame, m) {
  py::class_<Benne>(m, "Benne")
      .def(py::init<int, int, double, int, int, double, int, double>(),
           py::arg("dim") = 2, py::arg("n_clusters") = 3,
           py::arg("threshold") = 0.5, py::arg("queue_size_threshold") = 100,
           py::arg("dim_threshold") = 2, py::arg("variance_threshold") = 0.5,
  ...
  py::class_<Birch>(m, "Birch")
      .def(py::init<int, int, double, int>(), py::arg("dim") = 2,
           py::arg("n_clusters") = 3, py::arg("threshold") = 0.5,
