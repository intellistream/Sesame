...
private:
    ...
    void randomSelectCenters(int numberOfCenters, int numberOfInput, std::vector<PointPtr> &input,
    ...
    void groupPointsByCenters(int numberOfCenters, int numberOfInput, std::vector<PointPtr> &input,
                              std::vector<PointPtr> &centers,
    ...
    void checkStopStatus(bool &flag, std::vector<std::vector<PointPtr>> &oldGroups,
                         std::vector<std::vector<PointPtr>> &newGroups);
};
}  // namespace SESAME
