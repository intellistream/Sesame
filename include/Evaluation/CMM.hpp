...
public:
    ...
    CMMPoint(int id, long startTime, long time, std::vector<double> &vec, double a, double lambda,
             int truth);
...
public:
    ...
    void load(const std::vector<PointPtr> &inputs, const std::vector<PointPtr> &predicts, int dim,
              double weight);
    void voteMap();
...
public:
    ...
    double Evaluate(const std::vector<PointPtr> &inputs, const std::vector<PointPtr> &predicts);
    void AnalyseGT(const std::vector<PointPtr> &inputs, const std::vector<PointPtr> &predicts,
                   bool enableClassMerge);
    double CalcConn(int, const std::vector<PointPtr> &);
    double CalcConn(int, int, const std::vector<PointPtr> &);
    void CalcMatch(const std::vector<PointPtr> &inputs, const std::vector<PointPtr> &predicts);
    void CalcError(const std::vector<PointPtr> &inputs, const std::vector<PointPtr> &predicts);
